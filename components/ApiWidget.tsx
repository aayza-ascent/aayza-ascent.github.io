    ...
    <section id="api">
      <div className="container">
        ...
        <p style={{ maxWidth: 560, color: 'var(--ink-soft)', margin: '12px 0 48px' }}>
          This widget pulls a random programming joke from a public API each time you hit <em>refresh</em>. Tap the
          punchline to reveal it.
        </p>
        ...
        <div className="api-card glass">
          ...
          <div className={`api-body ${loading ? 'loading' : ''}`}>
            {loading ? (
              ...
              <>
                <div className="joke-setup serif">&ldquo;{joke.setup}&rdquo;</div>
                <button
          ...
          <div className="api-actions">
            <button className="btn btn-primary" onClick={fetchJoke} disabled={loading}>
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                style={{ animation: loading ? 'spinIcon 1s linear infinite' : 'none' }}
              >
                <path
        ...
        <div id="contact" className="contact-card">
          <div>
            ...
            <h3
              className="serif"
              style={{ fontSize: 'clamp(34px, 4vw, 56px)', lineHeight: 1.05, letterSpacing: '-.02em' }}
            >
              Got a project that needs a <em>careful engineer</em>?
            </h3>
            <p style={{ color: 'var(--ink-soft)', maxWidth: 520, marginTop: 14 }}>
              Open to thoughtful remote roles and consulting. TypeScript, React, full-stack builds, AI-assisted
              workflows — happy to chat whether you need a hand or a whole team.
            </p>
          </div>
          <div className="row" style={{ gap: 10, marginTop: 24 }}>
            <a href="mailto:aayzaahmed.wfh@gmail.com" className="btn btn-primary">
      ...
      <style jsx>{`
        ...
        .api-card {
          ...
          gap: 24px;
          background: linear-gradient(145deg, rgba(26, 22, 48, 0.85), rgba(14, 11, 26, 0.7));
        }
        .api-meta {
          display: flex;
        ...
        .joke-punch.shown {
          background: linear-gradient(135deg, rgba(110, 231, 183, 0.18), rgba(167, 139, 250, 0.15));
        ...
        .contact-card {
          ...
          padding: 56px;
          border-radius: 30px;
          background: linear-gradient(135deg, rgba(167, 139, 250, 0.2) 0%, rgba(255, 138, 184, 0.15) 100%);
        ...
        .contact-card::after {
          ...
          height: 240px;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(255, 138, 184, 0.3), transparent 70%);
          opacity: 0.7;
        }
        .contact-card > :global(*) {
          position: relative;
