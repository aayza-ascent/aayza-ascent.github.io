...
export const HOBBIES: Hobby[] = [
  {
    front: "Travel",
    back: "Social bunny with serious itchy feet - the list of countries to chase keeps growing. Goal: a stamp on every continent.",
    emoji: "✈️",
    color: "#A78BFA",
  },
  {
    front: "Strength training",
    back: "In the gym since 2022 - the routine sticks when you're going with friends, and that's hands down the best part.",
    emoji: "🏋️",
    color: "#FF6B9D",
  },
  {
    front: "Foodie",
    back: "Always chasing the next great meal - new restaurants, new cuisines, road trips for a single dish. If it's edible and excellent, I'm there.",
    emoji: "🍜",
    color: "#6EE7B7",
  },
  {
    front: "Badminton",
    back: "Casual doubles with friends - fast, social, and way more fun than it has any right to be.",
    emoji: "🏸",
    color: "#FBBF24",
  },
  {
    front: "Learning music",
    back: "Extreme beginner on guitar - but my partner plays in three bands, so live music is constantly on tap while I fumble through chords.",
    emoji: "🎸",
    color: "#67E8F9",
  },
  {
    front: "Running",
    back: "A few 10ks already in the bag. Half marathon is the next medal on the list.",
    emoji: "🏃‍♀️",
    color: "#F0ABFC",
  },
];
...
export const LIVE_SITES: LiveSite[] = [
  {
    title: "Plantry",
    subtitle: "Recipes · prices · meal plans",
    url: "https://plantry-aayza.vercel.app/",
    description:
      "Multi-user meal planner that scrapes recipes off the web, tracks live grocery prices across supermarkets, plans the week's meals, and rolls everything up into a shared shopping list.",
    year: "2026",
    role: "Sole Engineer",
    tint: "#6EE7B7",
    tag: "Live",
    stats: [
      ...
      { label: "scope", value: "Scrapers + UI" },
    ],
    preview: "linear-gradient(135deg, #6EE7B7 0%, #67E8F9 100%)",
  },
  {
    title: "Tabletop Companion",
    subtitle: "RPG campaign manager",
    url: "https://tabletop-companion.up.railway.app/login",
    description:
      "Web app for running tabletop RPG campaigns - invite the whole party, manage sessions, and gate sensitive lore behind DM-only permissions so players see exactly what you want them to see.",
    year: "2026",
    role: "Sole Engineer",
    tint: "#A78BFA",
    tag: "Live",
    stats: [
      { label: "type", value: "Full-stack" },
      { label: "scope", value: "Multi-user · perms" },
    ],
    preview: "linear-gradient(135deg, #A78BFA 0%, #6366F1 100%)",
  },
  {
    title: "Playing Card Games",
    subtitle: "Multiplayer card games · Expo",
    url: "https://github.com/aayza-ascent/playing-card-games",
    description:
      "Cross-platform Expo app for playing several card games online with up to four friends - handles dealing, turn order, and win conditions per game. Source on GitHub.",
    year: "2025",
    role: "Sole Engineer",
    tint: "#FF6B9D",
    tag: "Repo",
    stats: [
      { label: "stack", value: "Expo · RN" },
      { label: "players", value: "Up to 4" },
    ],
    preview: "linear-gradient(135deg, #FF6B9D 0%, #FBBF24 100%)",
  },
];
